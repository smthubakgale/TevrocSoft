...
onReady('#send-email-1 parent' , 'submit', (e) => 
{  
...
onReady('send-email-2 parent','submit', (e) => 
{  
	 var fm1 = document.getElementById("send-email-1").parentNode;
...
onReady('#send-email-3 parent','submit', (e) => 
{  
	 var fm1 = document.getElementById("send-email-1").parentNode;
...
onLoad("#plan-select" , ()=>
{
	...
	createDescription(field){
		...
		if (div2.style.display === 'none') {
			...
			if(field.description instanceof Promise)
			{
			field.description.then((html) => 
			{
				div2.innerHTML = html;
			});
			}
...
document.addEventListener("DOMContentLoaded", function() {  
    ...
    if (hash) {
        ...
        console.log('Hash without #: ', hashValue);
