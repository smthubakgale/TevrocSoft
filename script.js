...
function sendEmail(_name, _message, _email, formStatus, form, _subject = "Missing Subject") {
  const url = 'https://tevrocsoftapi.netlify.app/.netlify/functions/api/send-email2';
...
{  
     e.preventDefault();
	  ...
	  var fm3 = document.getElementById("contact-form");
     ...
     sendEmail(name , message , email , formStatus , fm3 , "Contact");
}); 
...
{  
     e.preventDefault();
	  ...
	  var fm3 = document.getElementById("license-contact-form");
